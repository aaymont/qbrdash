...
exports.odataProxy = void 0;
const https_1 = require("firebase-functions/v2/https");
/** Map MyGeotab server host to Data Connector base. 1=EU, 2=US, 3=CA, 4=AU, 5=BR, 6=AS, 7=USGov. */
function getDataConnectorBase(server) {
    const host = (server ?? "").toLowerCase().replace(/^https?:\/\//, "").split("/")[0];
    if (host.includes("my3."))
        return "https://odata-connector-1.geotab.com/odata/v4/svc";
    if (host.includes("my4."))
        return "https://odata-connector-4.geotab.com/odata/v4/svc";
    if (host.includes("my5."))
        return "https://odata-connector-5.geotab.com/odata/v4/svc";
    if (host.includes("my6."))
        return "https://odata-connector-6.geotab.com/odata/v4/svc";
    if (host.includes("my7."))
        return "https://odata-connector-7.geotab.com/odata/v4/svc";
    if (host.includes("my2."))
...
exports.odataProxy = (0, https_1.onRequest)(async (req, res) => {
    setCorsHeaders(res);
